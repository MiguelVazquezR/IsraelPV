<template>
    <div class="w-full mx-auto text-[11px] md:text-sm overflow-auto">
        <div class="text-center flex items-center space-x-4 mb-2">
            ...
            <div class="font-bold pb-3 px-2 text-left w-[35%] md:w-[30%]">Dirección</div>
            <div class="font-bold pb-3 px-2 text-left w-[10%]">Teléfono</div>
            <div class="font-bold pb-3 px-2 text-left w-[10%]">RFC</div>
            <!-- <div class="font-bold pb-3 text-left w-[10%]">Saldo pendiente</div> -->
            <div class="w-[17%]"></div>
        </div>
        <div>
            <div v-for="client in clients" :key="client.id"
                class="*:px-2 h-12 cursor-pointer flex items-center space-x-4 border rounded-full mb-2 hover:border-primarylight"
